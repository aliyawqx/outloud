...
export const CREDIT_PACKS = [
  // The $5 "urgent" mini pack: deliberately the WORST per-credit rate ($0.25/1k) -
  ...
  { id: 'pack_20k', label: '20,000 credits', credits: 20_000, priceUsd: 5, anchorUsd: 6, bestValue: false, productEnv: 'POLAR_PACK_20K_PRODUCT_ID' },
