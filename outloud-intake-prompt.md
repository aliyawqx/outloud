<!--
  ...
  Output: structured JSON { language, action: "ask" | "write", question, options, brief }.
  `language` is filled first so the model commits to the user's language before
  writing the question/options.
-->
